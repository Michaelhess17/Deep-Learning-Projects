...
class OUActionNoise(object):
    def __init__(self, mu, sigma=0.25, theta=.10, dt=1e-2, x0=None):
        self.theta = theta
        self.mu = mu
        self.sigma = sigma
        self.dt = dt
...
agent = Agent(alpha=0.00001, beta=0.00025, input_dims=[24], tau=0.001, env=env,
              batch_size=16,  layer1_size=400, layer2_size=300, n_actions=4)
